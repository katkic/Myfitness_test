module ApplicationHelper
  ...
  def set_post_picture(post)
    post.picture && post.picture.url ? post.picture.url : 'post_picture_default.png'
  end
  ...
  def set_body_picture2(body_status)
    body_status.picture2 && body_status.picture2.url ? body_status.picture2.url(:thumb) : 'no_image_gray_medium.png'
  end

  def set_body_picture3(body_status)
    body_status.picture3 && body_status.picture3.url ? body_status.picture3.url(:thumb) : 'no_image_gray_medium.png'
  end
